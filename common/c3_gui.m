...
% Text label, display markers
uicontrol('Parent',hPanelQRS,...
    'Style','text',...
    'Units','normalized',...
    'position',[0.11,0.95,0.88,0.0325],...
    'HorizontalAlignment','left',...
...
hIBIpanelCheckbox = uicontrol('Parent',hPanelQRS,...
    'Style','checkbox',...
    'Units','normalized',...
    'Position',[0.05,0.9,0.075,0.04],...
    'Value',1,...
    'Enable','on',...
    'BackgroundColor',panelColor);

% Text label, open IBI panel after detection
uicontrol('Parent',hPanelQRS,...
    'Style','text',...
    'Units','normalized',...
    'position',[0.11,0.9,0.88,0.0325],...
    'HorizontalAlignment','left',...
...
% Text label, display markers
uicontrol('Parent',hPanelIBI,...
    'Style','text',...
    'Units','normalized',...
    'position',[0.11,0.95,0.88,0.0325],...
    'HorizontalAlignment','left',...
    'String','Display IBI''s (display range must be <= 30 sec)',...
    'FontWeight','normal',...
    'ForegroundColor',[0 0 0],...
    'FontSize',8,...
    'BackgroundColor',panelColor);
...
hParentPanels = [hPanelParentFiltering,hPanelParentEventAnnotation,hPanelParentECGkitAnalysis,hPanelParentECGkitResults,hPanelParentQRS,hPanelParentIBI,hPanelParentOptionalPlots,hPanelParentExport];
    ...
    function stdSearchFcn(hCtrl,~)
        ...
        if searchVal
            ...
            if hCtrl == hStdSearchLeft
                ibiSegBool = ibiSegmentSampleNums < rangeStartIndex.ECG; 
            ...
            % Else, '>>' button was clicked
                ...
                ibiSegBool = ibiSegmentSampleNums > rangeEndIndex.ECG; 
...
function qrsAnn = loadQRS(last_path,bin_path)
    ...
    if fileName
        ...
        if ~isempty(jsondata_segment) && isfield(jsondata_segment,'ecgsampleoffset')
            qrsAnn{1,1} = qrsAnn{1,1} + jsondata_segment.ecgsampleoffset;
        else
            warndlg(sprintf(['JSON file for this analysis segment did not contain an "ecgsampleoffset" field!\n\n'...
